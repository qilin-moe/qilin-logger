...
exports.formatTimezone = exports.i18n = exports.masks = void 0;
...
function dateFormat(date, mask, utc, gmt) {
    ...
    mask = String(exports.masks[mask] || mask || exports.masks["default"]);
    ...
    const flags = {
        ...
        DDD: () => getDayName({
            ...
            d: d(),
            _: _(),
            dayName: exports.i18n.dayNames[D()],
            short: true
        }),
        ...
        DDDD: () => getDayName({
            ...
            d: d(),
            _: _(),
            dayName: exports.i18n.dayNames[D() + 7]
        }),
        m: () => m() + 1,
        mm: () => pad(m() + 1),
        ...
        t: () => H() < 12
            ? exports.i18n.timeNames[0]
            : exports.i18n.timeNames[1],
        tt: () => H() < 12
            ? exports.i18n.timeNames[2]
            : exports.i18n.timeNames[3],
        T: () => H() < 12
            ? exports.i18n.timeNames[4]
            : exports.i18n.timeNames[5],
        TT: () => H() < 12
            ? exports.i18n.timeNames[6]
            : exports.i18n.timeNames[7],
        Z: () => gmt
            ? "GMT"
            : utc
                ? "UTC"
                : (0, exports.formatTimezone)(date),
        o: () => (o() > 0 ? "-" : "+") +
